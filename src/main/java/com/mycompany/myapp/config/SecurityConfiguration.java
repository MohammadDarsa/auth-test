...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers("/api/students/**").hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.CLERIC)
            .antMatchers("/api/transcripts/**").hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.CLERIC)
            .antMatchers("/api/student").hasAuthority(AuthoritiesConstants.USER)
            .antMatchers("/api/transcribe").hasAuthority(AuthoritiesConstants.USER)
        .and()
            .oauth2Login()
        .and()
