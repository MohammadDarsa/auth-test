...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Transcript}.
 */
@RestController
@RequestMapping("/api")
public class TranscriptResource {
    ...
    public ResponseEntity<TranscriptDTO> updateTranscript(
        ...
        @RequestBody TranscriptDTO transcriptDTO
        ...
        TranscriptDTO result = transcriptService.update(transcriptDTO);
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, transcriptDTO.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<TranscriptDTO> partialUpdateTranscript(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, transcriptDTO.getId().toString())
        );
    }
